...
const ExplodedCube = dynamic(
  () => import("@/components/effects/ExplodedCube"),
  { ssr: false }
);
        ...
        <Section id="experience" title="Experience">
          ...
          >
            ...
            <p className="mt-8 text-base md:text-lg opacity-70 dark:text-white/70 leading-relaxed max-w-2xl mx-auto">
              Built scalable Node.js backend services, engineered RESTful APIs,
              optimized MongoDB data layers, enforced application-level
              security, and collaborated with front-end teams to deliver
